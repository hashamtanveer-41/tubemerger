...
from tubemerger.apps.merger.services.downloaders.merge_pipeline import MergePipeline
from tubemerger.apps.merger.services.downloaders.single_downloader import SingleDownloader
from tubemerger.apps.merger.services.format_builder import (
...
from tubemerger.apps.merger.services.process_manager import (
    deregister_process,
...
from tubemerger.apps.merger.services.specs import (
    MergeJobSpec,
    PipelineStatus,
    ProgressSnapshot,
)
from tubemerger.apps.merger.services.stitcher import VideoStitcherService
from tubemerger.apps.telemetry.service import (
...
class MergeEngine:
    ...
    def _emit(self, snapshot: ProgressSnapshot) -> None:
        ...
        if snapshot.status == PipelineStatus.DONE:
            try:
                from tubemerger.apps.queues.services import QueueService
